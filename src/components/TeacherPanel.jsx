...
const TeacherPanel = () => {
  ...
  // ✅ Base URL handle (local + production)
  const BASE_URL =
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${BASE_URL}/students/add`, formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });

      setMessage(res.data.msg || "✅ Student added successfully");
      setName("");
      setEmail("");
      setFile(null);
      setCourseId("");
              ...
              {students.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-400 mt-2">
                    Enroll your first student to see them here
                  </p>
                </div>
              )}
            </div>
